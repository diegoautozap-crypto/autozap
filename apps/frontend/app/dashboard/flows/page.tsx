...
IMPORTANTE: Personalize este prompt com informações do seu negócio (serviços, preços, horários, etc.)` } },
    ...
    },
    {
      ...
      nodes: [
        // ═══ NÍVEL 0: TRIGGER ═══
        { id: 'n1', type: 'trigger_any_reply', position_x: 600, position_y: 0, data: { type: 'trigger_any_reply' } },
        ...
        { id: 'na4', type: 'send_message', position_x: 0, position_y: 1800, data: { type: 'send_message', subtype: 'text', message: 'Obrigado pelo contato! Se precisar, é só nos chamar novamente. 😊' } },
