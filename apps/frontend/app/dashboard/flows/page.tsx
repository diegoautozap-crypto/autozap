...
IMPORTANTE: Personalize este prompt com informações do seu negócio (serviços, preços, horários, etc.)` } },
    ...
    false && {
      ...
      nodes: [
        ...
        { id: 'n5', type: 'send_message', position_x: 0, position_y: 650, data: { type: 'send_message', subtype: 'list', message: 'Selecione o assunto:', listButtonText: 'Ver opções', listRows: [{ title: 'Campeonato' }, { title: 'Escolinha' }, { title: 'Ayrton Senna' }, { title: '↩️ Voltar ao menu' }] } },
        ...
        { id: 'n7', type: 'condition', position_x: 0, position_y: 950, data: { type: 'condition', branches: [
          ...
          { id: 'bo4', label: '↩️ Voltar', logic: 'AND', rules: [{ id: 'ro4', field: 'variable', fieldName: 'outro_assunto', operator: 'contains', value: 'Voltar' }] },
        ] } },
        ...
        { id: 'n14', type: 'send_message', position_x: 600, position_y: 650, data: { type: 'send_message', subtype: 'buttons', message: 'Qual tipo de reserva?', buttons: [{ title: 'Churrasqueira' }, { title: 'Eventos' }, { title: '↩️ Voltar' }] } },
        ...
        { id: 'n16', type: 'condition', position_x: 600, position_y: 950, data: { type: 'condition', branches: [
          ...
          { id: 'br3', label: '↩️ Voltar', logic: 'AND', rules: [{ id: 'rr3', field: 'variable', fieldName: 'tipo_reserva', operator: 'contains', value: 'Voltar' }] },
        ] } },
        ...
        { id: 'n19', type: 'send_message', position_x: 1200, position_y: 650, data: { type: 'send_message', subtype: 'buttons', message: 'Selecione uma opção:', buttons: [{ title: 'Horários' }, { title: 'Mensalista' }, { title: '↩️ Voltar' }] } },
        ...
        { id: 'n21', type: 'condition', position_x: 1200, position_y: 950, data: { type: 'condition', branches: [
          ...
          { id: 'bq3', label: '↩️ Voltar', logic: 'AND', rules: [{ id: 'rq3', field: 'variable', fieldName: 'opcao_quadra', operator: 'contains', value: 'Voltar' }] },
        ] } },
        ...
        { id: 'n25', type: 'condition', position_x: 1200, position_y: 1450, data: { type: 'condition', branches: [
          ...
          { id: 'bt3', label: '↩️ Voltar', logic: 'AND', rules: [{ id: 'rt3', field: 'variable', fieldName: 'tipo_quadra', operator: 'contains', value: 'Voltar' }] },
        ] } },
      ...
      edges: [
        ...
        // Voltar outro assunto → menu
        { id: 'evo', source_node: 'n7', target_node: 'n2', source_handle: 'branch_bo4' },
        ...
        // Voltar reservas → menu
        { id: 'evr', source_node: 'n16', target_node: 'n2', source_handle: 'branch_br3' },
        // Fallback reservas
        ...
        // Voltar quadra → menu
        { id: 'evq', source_node: 'n21', target_node: 'n2', source_handle: 'branch_bq3' },
        // Fallback quadra
        ...
        // Voltar escolher quadra → menu quadra
        { id: 'evt', source_node: 'n25', target_node: 'n19', source_handle: 'branch_bt3' },
    ...
    // ─── 4 templates novos prontos pra usar ────────────────────────────────────

    {
      id: 'onboarding_complete',
      emoji: '🚀',
      name: 'Onboarding novo cliente',
      desc: 'Coleta nome + email + CPF com validação, busca dados, atribui agente e notifica equipe',
      category: t('flows.categoryIntermediate'),
      categoryKey: 'intermediate',
      nodes: [
        { id: 'n1', type: 'trigger_first_message', position_x: 50, position_y: 250, data: { type: 'trigger_first_message' } },
        { id: 'n2', type: 'send_message', position_x: 320, position_y: 250, data: { type: 'send_message', subtype: 'text', message: 'Olá! 👋 Bem-vindo(a). Vou te cadastrar rapidinho.\n\nPra começar, qual seu nome completo?' } },
        { id: 'n3', type: 'input', position_x: 590, position_y: 250, data: { type: 'input', question: '', saveAs: 'nome', validationType: 'text' } },
        { id: 'n4', type: 'input', position_x: 860, position_y: 250, data: { type: 'input', question: 'Perfeito, {{nome}}! Agora seu melhor e-mail?', saveAs: 'email', validationType: 'email', validationErrorMessage: 'Hmm, esse e-mail não parece válido. Tenta de novo? 🙂', validationMaxAttempts: 3 } },
        { id: 'n5', type: 'input', position_x: 1130, position_y: 250, data: { type: 'input', question: 'Por último, qual seu CPF?', saveAs: 'cpf', validationType: 'cpf', validationErrorMessage: 'CPF inválido. Confere por favor 🙏', validationMaxAttempts: 3 } },
        { id: 'n6', type: 'update_contact', position_x: 1400, position_y: 250, data: { type: 'update_contact', name: '{{nome}}', email: '{{email}}', customFields: [{ key: 'cpf', value: '{{cpf}}' }] } },
        { id: 'n7', type: 'send_message', position_x: 1670, position_y: 250, data: { type: 'send_message', subtype: 'text', message: '✅ Tudo certo, {{nome}}!\n\nVou te conectar com nosso time agora 🚀' } },
        { id: 'n8', type: 'assign_agent', position_x: 1940, position_y: 250, data: { type: 'assign_agent', agentId: 'round_robin' } },
        { id: 'n9', type: 'send_notification', position_x: 1940, position_y: 100, data: { type: 'send_notification', notificationMessage: 'Novo cliente cadastrado: {{nome}} ({{email}})' } },
      ],
      edges: [
        { id: 'e1', source_node: 'n1', target_node: 'n2', source_handle: 'success' },
        { id: 'e2', source_node: 'n2', target_node: 'n3', source_handle: 'success' },
        ...
        { id: 'e6', source_node: 'n6', target_node: 'n7', source_handle: 'success' },
        { id: 'e7', source_node: 'n7', target_node: 'n8', source_handle: 'success' },
        { id: 'e8', source_node: 'n7', target_node: 'n9', source_handle: 'success' },
      ],
    },

    {
      ...
      emoji: '💸',
      name: 'Cobrança / Lembrete de pagamento',
      desc: 'Manda lembrete educado, pergunta se já pagou, ramifica entre confirmação e renegociação',
      category: t('flows.categoryIntermediate'),
      categoryKey: 'intermediate',
      nodes: [
        { id: 'n1', type: 'trigger_keyword', position_x: 50, position_y: 250, data: { type: 'trigger_keyword', keywords: ['cobrar', 'pagamento', 'fatura'], matchType: 'contains' } },
        { id: 'n2', type: 'lookup_contact', position_x: 320, position_y: 250, data: { type: 'lookup_contact', includeTags: true, includePurchases: true } },
        { id: 'n3', type: 'send_message', position_x: 590, position_y: 250, data: { type: 'send_message', subtype: 'text', message: 'Oi {{contact_name}}! 👋\n\nPassando rapidinho pra lembrar do pagamento pendente.\n\nVocê já fez ou ainda tá em andamento?' } },
        { id: 'n4', type: 'input', position_x: 860, position_y: 250, data: { type: 'input', question: 'Responde "ja paguei" ou "ainda nao"', saveAs: 'status_pgto' } },
        { id: 'n5', type: 'condition', position_x: 1130, position_y: 250, data: { type: 'condition', branches: [
          { id: 'b1', label: 'Já pagou', logic: 'OR', rules: [{ id: 'r1', field: 'variable', fieldName: 'status_pgto', operator: 'contains', value: 'paguei, pago, sim, ja' }] },
          { id: 'b2', label: 'Não pagou', logic: 'OR', rules: [{ id: 'r2', field: 'variable', fieldName: 'status_pgto', operator: 'contains', value: 'nao, ainda, depois, esqueci' }] },
        ] } },
        { id: 'n6', type: 'send_message', position_x: 1450, position_y: 100, data: { type: 'send_message', subtype: 'text', message: 'Que ótimo! 🎉 Vou confirmar com nosso financeiro e te dou retorno em até 1 dia útil.\n\nObrigado pela parceria 🙏' } },
        { id: 'n7', type: 'create_task', position_x: 1750, position_y: 100, data: { type: 'create_task', taskTitle: 'Confirmar pagamento de {{contact_name}}', taskDueHours: 24 } },
        { id: 'n8', type: 'send_message', position_x: 1450, position_y: 400, data: { type: 'send_message', subtype: 'text', message: 'Sem problema! Vou te conectar com nosso time pra organizar uma forma que te atenda 💚' } },
        { id: 'n9', type: 'assign_agent', position_x: 1750, position_y: 400, data: { type: 'assign_agent' } },
      ],
      edges: [
        { id: 'e1', source_node: 'n1', target_node: 'n2', source_handle: 'success' },
        { id: 'e2', source_node: 'n2', target_node: 'n3', source_handle: 'success' },
        ...
        { id: 'e5', source_node: 'n5', target_node: 'n6', source_handle: 'branch_b1' },
        { id: 'e6', source_node: 'n6', target_node: 'n7', source_handle: 'success' },
        { id: 'e7', source_node: 'n5', target_node: 'n8', source_handle: 'branch_b2' },
...

    {
      id: 'pos_venda_nps',
      emoji: '⭐',
      name: 'Pós-venda NPS (CSAT)',
      desc: 'Espera 2h após atendimento, pergunta nota 0-10 e ramifica promoter/passive/detractor',
      category: t('flows.categoryIntermediate'),
      categoryKey: 'intermediate',
      nodes: [
        { id: 'n1', type: 'trigger_keyword', position_x: 50, position_y: 300, data: { type: 'trigger_keyword', keywords: ['avaliar', 'feedback', 'nota'], matchType: 'contains' } },
        { id: 'n2', type: 'wait', position_x: 320, position_y: 300, data: { type: 'wait', mode: 'duration', hours: 2 } },
        { id: 'n3', type: 'csat', position_x: 590, position_y: 300, data: { type: 'csat', question: 'De 0 a 10, como você avalia nosso atendimento hoje?', invalidMessage: 'Por favor, responda com uma nota de 0 a 10 🙂' } },
        { id: 'n4', type: 'send_message', position_x: 900, position_y: 100, data: { type: 'send_message', subtype: 'text', message: 'Que demais! 🙌 Se puder, deixe uma review pra gente: [seu link Google]. Significa muito 💚' } },
        { id: 'n5', type: 'send_message', position_x: 900, position_y: 300, data: { type: 'send_message', subtype: 'text', message: 'Obrigado pelo feedback! 👍' } },
        { id: 'n6', type: 'send_message', position_x: 900, position_y: 500, data: { type: 'send_message', subtype: 'text', message: 'Sentimos muito pela experiência. Um gerente vai entrar em contato nas próximas horas pra entender melhor e melhorar 🙏' } },
        { id: 'n7', type: 'create_task', position_x: 1200, position_y: 500, data: { type: 'create_task', taskTitle: '⚠ Cliente insatisfeito {{contact_name}} — recuperar urgente', taskDueHours: 2 } },
      ],
      edges: [
        { id: 'e1', source_node: 'n1', target_node: 'n2', source_handle: 'success' },
        { id: 'e2', source_node: 'n2', target_node: 'n3', source_handle: 'success' },
        { id: 'e3', source_node: 'n3', target_node: 'n4', source_handle: 'promoter' },
        { id: 'e4', source_node: 'n3', target_node: 'n5', source_handle: 'passive' },
        { id: 'e5', source_node: 'n3', target_node: 'n6', source_handle: 'detractor' },
        { id: 'e6', source_node: 'n6', target_node: 'n7', source_handle: 'success' },
      ],
    },

    {
      ...
      desc: 'Quando cliente sumir/desistir, oferece desconto, espera resposta e ramifica',
      category: t('flows.categoryIntermediate'),
      categoryKey: 'intermediate',
      nodes: [
        { id: 'n1', type: 'trigger_keyword', position_x: 50, position_y: 300, data: { type: 'trigger_keyword', keywords: ['caro', 'depois', 'pensar', 'desistir', 'mais tarde'], matchType: 'contains' } },
        { id: 'n2', type: 'lookup_contact', position_x: 320, position_y: 300, data: { type: 'lookup_contact', includeTags: true, includePurchases: false } },
        { id: 'n3', type: 'send_message', position_x: 590, position_y: 300, data: { type: 'send_message', subtype: 'text', message: 'Tranquilo {{contact_name}}, sem pressão 😉\n\nAntes de sair, posso te oferecer um cupom de 10% pra fechar hoje?\n\nResponde "SIM" ou "NÃO".' } },
        { id: 'n4', type: 'input', position_x: 860, position_y: 300, data: { type: 'input', question: '', saveAs: 'aceitou', timeoutHours: 24 } },
        { id: 'n5', type: 'condition', position_x: 1130, position_y: 300, data: { type: 'condition', branches: [
          { id: 'b1', label: 'Aceitou', logic: 'OR', rules: [{ id: 'r1', field: 'variable', fieldName: 'aceitou', operator: 'contains', value: 'sim, aceito, quero, claro' }] },
        ] } },
        { id: 'n6', type: 'send_message', position_x: 1450, position_y: 100, data: { type: 'send_message', subtype: 'text', message: '🎉 Perfeito! Seu cupom: **DESCONTO10**\n\nVálido por 24h. Só me avisa quando finalizar 👍' } },
        { id: 'n7', type: 'tag_contact', position_x: 1750, position_y: 100, data: { type: 'tag_contact', subtype: 'add' } },
        { id: 'n8', type: 'create_task', position_x: 2050, position_y: 100, data: { type: 'create_task', taskTitle: 'Acompanhar carrinho de {{contact_name}} (cupom dado)', taskDueHours: 24 } },
        { id: 'n9', type: 'send_message', position_x: 1450, position_y: 500, data: { type: 'send_message', subtype: 'text', message: 'Tranquilo! Quando quiser dar outra olhada, é só me chamar 🙂' } },
        { id: 'n10', type: 'wait', position_x: 1750, position_y: 500, data: { type: 'wait', mode: 'duration', days: 7 } },
        { id: 'n11', type: 'send_message', position_x: 2050, position_y: 500, data: { type: 'send_message', subtype: 'text', message: 'Oi {{contact_name}}, tudo bem? Lembrei daqui — ainda tem interesse? Posso te ajudar com mais alguma coisa 😊' } },
      ],
      edges: [
        { id: 'e1', source_node: 'n1', target_node: 'n2', source_handle: 'success' },
        { id: 'e2', source_node: 'n2', target_node: 'n3', source_handle: 'success' },
        ...
        { id: 'e6', source_node: 'n6', target_node: 'n7', source_handle: 'success' },
        { id: 'e7', source_node: 'n7', target_node: 'n8', source_handle: 'success' },
        { id: 'e8', source_node: 'n5', target_node: 'n9', source_handle: 'fallback' },
        { id: 'e9', source_node: 'n9', target_node: 'n10', source_handle: 'success' },
