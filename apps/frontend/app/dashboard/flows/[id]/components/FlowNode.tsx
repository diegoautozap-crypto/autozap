  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: selected ? `0 0 0 3px ${color}33` : '0 4px 16px rgba(0,0,0,.2)',
      ...
      {data.type === 'input' && (data.timeoutHours > 0 || data.timeoutMinutes > 0) ? (
        <>
          <Handle type="source" position={Position.Right} id="success"
            style={{ background: color, width: 16, height: 16, border: '3px solid #fff', position: 'absolute', right: -9, top: 20, transform: 'none', zIndex: 10 }} />
          <Handle type="source" position={Position.Right} id="timeout"
            style={{ background: '#ef4444', width: 16, height: 16, border: '3px solid #fff', position: 'absolute', right: -9, top: 60, transform: 'none', zIndex: 10 }} />
          <div style={{ position: 'absolute', right: -72, top: 14, fontSize: '9px', color: '#6b7280', fontWeight: 600 }}>✓ {t('nodes.responseLabel')}</div>
          <div style={{ position: 'absolute', right: -62, top: 54, fontSize: '9px', color: '#ef4444', fontWeight: 600 }}>⏰ {t('nodes.timeoutLabel')}</div>
        </>
