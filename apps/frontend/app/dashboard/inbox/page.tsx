      ...
      <div className="inbox-list" style={{ width: isMobile ? '100%' : '300px', flexShrink: 0, background: 'var(--bg-card)', borderRight: isMobile ? 'none' : '1px solid var(--border)', display: isMobile && mobileShowChat ? 'none' : 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        <div style={{ padding: '14px 14px 10px', borderBottom: '1px solid var(--divider)', flexShrink: 0 }}>
          <div className="mobile-header" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '10px' }}>
            <h2 style={{ fontSize: '15px', fontWeight: 700, color: 'var(--text)', letterSpacing: '-0.02em', margin: 0 }}>Inbox</h2>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <input style={{ width: '100%', padding: '7px 10px 7px 30px', background: 'var(--bg-input)', border: '1px solid var(--border)', borderRadius: '8px', fontSize: '13px', outline: 'none', color: 'var(--text)', boxSizing: 'border-box' as const }} placeholder="Buscar contato..." value={search} onChange={e => setSearch(e.target.value)}
        ...
        <div style={{ flex: 1, overflowY: 'auto' }} onScroll={handleConvScroll}>
          {loadingConvs && convPage === 1
            ...
            ? <div style={{ padding: '40px', textAlign: 'center' }}><div style={{ width: '40px', height: '40px', borderRadius: '10px', background: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 10px' }}><MessageSquare size={18} color="var(--text-faintest)" /></div><p style={{ color: 'var(--text-faint)', fontSize: '13px' }}>Nenhuma conversa</p></div>
      ...
      <div className="inbox-chat" style={{ flex: 1, display: isMobile && !mobileShowChat ? 'none' : 'flex', flexDirection: 'column', minWidth: 0, overflow: 'hidden', width: isMobile ? '100%' : undefined }}>
        {!selectedConvId ? (
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '12px', background: 'var(--bg)' }}>
            ...
            <p style={{ color: 'var(--text-faint)', fontSize: '14px', fontWeight: 500 }}>Selecione uma conversa</p>
          </div>
        ) : (
          <>
            <div style={{ padding: '10px 16px', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'var(--bg-card)', flexShrink: 0 }}>
              ...
              <div className="mobile-header-actions" style={{ display: 'flex', gap: '6px', alignItems: 'center' }}>
                ...
                {selectedConv?.status !== 'closed'
                  ? <button onClick={closeConv} style={{ padding: '5px 12px', background: 'var(--bg-input)', border: '1px solid var(--border)', borderRadius: '7px', fontSize: '12px', cursor: 'pointer', color: 'var(--text-muted)', fontWeight: 500 }}>Fechar</button>
            ...
            <div style={{ flex: 1, overflowY: 'auto', padding: '16px 20px', display: 'flex', flexDirection: 'column', gap: '6px', background: 'var(--bg)' }}>
              {loadingMessages
                ...
                : messages?.length === 0
                ? <p style={{ textAlign: 'center', color: 'var(--text-faint)', fontSize: '13px', padding: '40px' }}>Nenhuma mensagem ainda</p>
            ...
            {selectedConv?.status !== 'closed' ? (
                ...
                <div style={{ padding: '10px 12px' }}>
                  {visibleChannels.length > 1 && inputMode === 'message' && (
                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '6px' }}>
                      ...
                      <span style={{ fontSize: '11px', color: 'var(--text-faint)' }}>Enviar por:</span>
                      <select
                  ...
                  {isRecording ? (
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                      ...
                      <div style={{ flex: 1 }} />
                      <button onClick={cancelRecording} style={{ padding: '6px 12px', background: 'var(--bg-input)', border: '1px solid var(--border)', borderRadius: '7px', fontSize: '12px', cursor: 'pointer', color: 'var(--text-muted)' }}>Cancelar</button>
              ...
              <div style={{ padding: '12px 16px', borderTop: '1px solid var(--border)', background: 'var(--bg-card)', textAlign: 'center', flexShrink: 0 }}>
                <span style={{ fontSize: '13px', color: 'var(--text-faint)' }}>Conversa fechada</span>
              </div>
            )}
          </>
        )}
        ...
        <div className="inbox-profile" style={{ width: '248px', flexShrink: 0, background: 'var(--bg-card)', borderLeft: '1px solid var(--border)', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '14px 16px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '11px' }}>
              ...
              {pipelineInfo && (
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
                  ...
                  <div><p style={{ fontSize: '10px', color: 'var(--text-faint)', margin: '0 0 3px', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Pipeline</p>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
                ...
                <div><p style={{ fontSize: '10px', color: 'var(--text-faint)', margin: '0 0 3px', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Bot</p>
              ...
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '6px' }}><UserCheck size={13} color="var(--text-faint)" /><p style={{ fontSize: '10px', color: 'var(--text-faint)', margin: 0, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Atendente</p></div>
                <select value={selectedConv?.assigned_to || ''} onChange={e => assignMutation.mutate(e.target.value || null)} disabled={assignMutation.isPending} style={{ width: '100%', padding: '6px 8px', background: 'var(--bg-input)', border: '1px solid var(--border)', borderRadius: '7px', fontSize: '12px', color: 'var(--text)', outline: 'none', cursor: 'pointer' }}>
                  <option value="">Sem atribuição</option>
                  {(teamMembers || []).map((m: any) => <option key={m.id} value={m.id}>{m.name || m.email}</option>)}
                </select>
              </div>
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '6px' }}><Tag size={13} color="var(--text-faint)" /><p style={{ fontSize: '10px', color: 'var(--text-faint)', margin: 0, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Tags</p></div>
            ...
            <div style={{ marginTop: '16px', paddingTop: '14px', borderTop: '1px solid var(--divider)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '10px' }}><StickyNote size={13} color="#d97706" /><p style={{ fontSize: '10px', fontWeight: 700, color: 'var(--text-faint)', textTransform: 'uppercase', letterSpacing: '0.08em', margin: 0 }}>Notas internas</p></div>
              {(notes as any[]).length === 0
                ? <p style={{ fontSize: '12px', color: 'var(--text-faintest)', textAlign: 'center', padding: '8px 0' }}>Nenhuma nota ainda</p>
            ...
            <div style={{ marginTop: '16px', paddingTop: '14px', borderTop: '1px solid var(--divider)' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}><Check size={13} color="#2563eb" /><p style={{ fontSize: '10px', fontWeight: 700, color: 'var(--text-faint)', textTransform: 'uppercase', letterSpacing: '0.08em', margin: 0 }}>Tarefas</p></div>
                <button onClick={async () => {
              ...
              {convTasks.length === 0
                  ? <p style={{ fontSize: '12px', color: 'var(--text-faintest)', textAlign: 'center', padding: '4px 0' }}>Nenhuma tarefa</p>
