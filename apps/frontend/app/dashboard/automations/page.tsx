...
function SortableAutomationCard({
  ...
  const style: React.CSSProperties = {
    ...
    transition,
    background: '#fff',
    border: `1px solid ${isDragging ? '#16a34a' : '#e5e7eb'}`,
    borderRadius: '12px',
    padding: '16px 20px',
    display: 'flex',
    alignItems: 'center',
    ...
    <div ref={setNodeRef} style={style}>
      <div
        ...
        style={{
          ...
          color: isDragging ? '#16a34a' : '#d1d5db',
          display: 'flex',
          alignItems: 'center',
          flexShrink: 0,
          padding: '2px',
      ...
      <div style={{ flex: 1 }}>
        ...
        <p style={{ fontSize: '12px', color: '#6b7280' }}>
          ...
          <span style={{ color: '#374151', fontWeight: 500 }}>Então: </span>{actionLabel(automation)}
        </p>
      </div>
            ...
            {form.trigger_type === 'first_message' && (
              <div>
                ...
                <input style={inputStyle} placeholder="campanha1, promo, desconto — deixe vazio para qualquer mensagem"
                  ...
                  onChange={e => setForm({ ...form, trigger_value: { ...form.trigger_value, keywords: e.target.value } })} />
                <p style={{ fontSize: '11px', color: '#9ca3af', marginTop: '4px' }}>Se preenchido, dispara apenas se a primeira mensagem contiver uma dessas palavras.</p>
              </div>
            )}
              ...
              <div style={{ display: 'grid', gap: '12px' }}>
                <div>
                  ...
                  <textarea style={{ ...inputStyle, minHeight: '80px', resize: 'vertical' as any }}
                    placeholder="Olá! Estamos fora do horário. Use {{phone}} para o número do contato."
      ...
      {isLoading ? (
        ...
        <>
          ...
          <DndContext sensors={sensors} collisionDetection={closestCenter} onDragEnd={handleDragEnd}>
            <SortableContext items={displayList.map((a: any) => a.id)} strategy={verticalListSortingStrategy}>
